...
from ..models.create_user_body_password_hasher import CreateUserBodyPasswordHasher
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.create_user_body_private_metadata import CreateUserBodyPrivateMetadata
    from ..models.create_user_body_public_metadata import CreateUserBodyPublicMetadata
    from ..models.create_user_body_unsafe_metadata import CreateUserBodyUnsafeMetadata
...
class CreateUserBody:
    ...
    Attributes:
        ...
        password_hasher (Union[Unset, CreateUserBodyPasswordHasher]): The hashing algorithm that was used to generate
            the password digest.
        ...
        public_metadata (Union[Unset, CreateUserBodyPublicMetadata]): Metadata saved on the user, that is visible to
            both your Frontend and Backend APIs
        private_metadata (Union[Unset, CreateUserBodyPrivateMetadata]): Metadata saved on the user, that is only visible
            to your Backend API
        unsafe_metadata (Union[Unset, CreateUserBodyUnsafeMetadata]): Metadata saved on the user, that can be updated
    ...
    password_hasher: Union[Unset, CreateUserBodyPasswordHasher] = UNSET
    ...
    public_metadata: Union[Unset, "CreateUserBodyPublicMetadata"] = UNSET
    private_metadata: Union[Unset, "CreateUserBodyPrivateMetadata"] = UNSET
    unsafe_metadata: Union[Unset, "CreateUserBodyUnsafeMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        password_hasher: Union[Unset, CreateUserBodyPasswordHasher]
        if isinstance(_password_hasher, Unset):
            password_hasher = UNSET
        else:
            password_hasher = CreateUserBodyPasswordHasher(_password_hasher)
        ...
        public_metadata: Union[Unset, CreateUserBodyPublicMetadata]
        if isinstance(_public_metadata, Unset):
            public_metadata = UNSET
        else:
            public_metadata = CreateUserBodyPublicMetadata.from_dict(_public_metadata)

        _private_metadata = d.pop("private_metadata", UNSET)
        private_metadata: Union[Unset, CreateUserBodyPrivateMetadata]
        if isinstance(_private_metadata, Unset):
            private_metadata = UNSET
        else:
            private_metadata = CreateUserBodyPrivateMetadata.from_dict(_private_metadata)

        _unsafe_metadata = d.pop("unsafe_metadata", UNSET)
        unsafe_metadata: Union[Unset, CreateUserBodyUnsafeMetadata]
        if isinstance(_unsafe_metadata, Unset):
            unsafe_metadata = UNSET
        else:
            unsafe_metadata = CreateUserBodyUnsafeMetadata.from_dict(_unsafe_metadata)
