...
from ..models.update_user_body_password_hasher import UpdateUserBodyPasswordHasher
...
class UpdateUserBody:
    ...
    Attributes:
        ...
        password_hasher (Union[Unset, UpdateUserBodyPasswordHasher]): The hashing algorithm that was used to generate
            the password digest.
    ...
    password_hasher: Union[Unset, UpdateUserBodyPasswordHasher] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        password_hasher: Union[Unset, UpdateUserBodyPasswordHasher]
        if isinstance(_password_hasher, Unset):
            password_hasher = UNSET
        else:
            password_hasher = UpdateUserBodyPasswordHasher(_password_hasher)
